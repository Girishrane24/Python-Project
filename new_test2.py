    ...
    for type_of_sub in quiz_data:
        ...
        for level in quiz_data[type_of_sub]:
            ...
            for question_no in quiz_data[type_of_sub][level]:
                ...
                print("Answer is :",quiz_data[type_of_sub][level][question_no]['answer'])
            print('\n')
...
def Login(di):
    ...
    while True:    
        ...
        if(user in di["user"]):
            ...
            print("user does not exit Register Again")
            di=registeration(di)      
    return di
...
def registeration(di):
    ...
    while True:
        ...
        passw=input("password: ")
        if(user in di["user"]):
            print("Username is exits, please choose other user name and password") 
            continue
        di["user"][user]=passw 
